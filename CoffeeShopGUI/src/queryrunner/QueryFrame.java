...
public class QueryFrame extends javax.swing.JFrame
{
   ...
   /**
    * This is the constructer for QueryFrame. It will initialize the Combobox
   ...
   private void initComponents()
   {
      ...
      getContentPane().add(jTextField1,
            new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 140, 120,
                  -1));
      ...
      getContentPane().add(jScrollPane1,
            new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 40, 350,
                  140));
      ...
      getContentPane().add(jScrollPane2,
            new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 40, 330,
                  140));

      jTextField2.setNextFocusableComponent(jTextField3);
      getContentPane().add(jTextField2,
            new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 50, 120,
                  -1));

      jTextField3.setNextFocusableComponent(jPasswordField1);
      getContentPane().add(jTextField3,
            new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 80, 120,
                  -1));

      jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
      jPanel1.add(jTextField5,
            new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 26, 149,
                  -1));
      jPanel1.add(jTextField6,
            new org.netbeans.lib.awtextra.AbsoluteConstraints(457, 26, 190,
                  -1));
      jPanel1.add(jTextField7,
            new org.netbeans.lib.awtextra.AbsoluteConstraints(771, 26, 160,
                  -1));
      jPanel1.add(jTextField8,
            new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 64, 150,
                  -1));
      ...
      jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(
            651, 67, 116, -1));

      jLabel11.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
      jLabel11.setText("iii");
      jLabel11.setToolTipText("");
      jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(
            27, 102, 123, -1));

      jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
      jLabel12.setText("ooo");
      jLabel12.setToolTipText("");
      jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(
            353, 102, 100, -1));
      jPanel1.add(jTextField9,
            new org.netbeans.lib.awtextra.AbsoluteConstraints(459, 64, 188,
                  -1));
      jPanel1.add(jTextField10,
            new org.netbeans.lib.awtextra.AbsoluteConstraints(771, 64, 160,
                  -1));
      jPanel1.add(jTextField11,
            new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 99, 150,
                  -1));
      jPanel1.add(jTextField12,
            new org.netbeans.lib.awtextra.AbsoluteConstraints(457, 99, 190,
                  -1));
      ...
      getContentPane().add(jButton2,
            new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 190, -1,
                  -1));
   ...
   {// GEN-FIRST:event_jButton1ActionPerformed
      ...
      {
         bOK = m_queryrunner.Connect(this.jTextField2.getText(),
               this.jTextField3.getText(), String.valueOf(this.jPasswordField1
                     .getPassword()), this.jTextField1.getText());
         if (bOK == true)
         {
    ...
    * drop down box. It will recognize which one is selected and get the
    * correct Query Data that it will then use to populate the TextArea that
    * display's the query. It will also recognize if it is a "parameter" query.
    * If it is, it will make the PANEL Control which holds the parameter data
    * to be visible, and will put the appropriate parameter labels along with
    * their textboxes.
    * 
    * @param evt
    */
   ...
   {// GEN-FIRST:event_jComboBox1ActionPerformed
      ...
      if (this.m_queryrunner.isParameterQuery(m_queryChoice))
      {
         ...
         for (int i = 0; i < nAmt; i++)
         {
            ...
            m_parmlabels[i].setText(m_queryrunner.GetParamText(m_queryChoice,
                  i));
   ...
   /**
    * This is the Action handler for the "RUN QUERY" button. It tries to
    * identify If it is an action query first. If it is, it will take the
    * parameter data from the various textboxes and create a parameter array
    * that it will eventually pass to the ExecuteQuery function. If it is a
    * query that returns a resultset, it will create a JTABLE which is a GUI
    * Control that enables the resultset data to transferred to it.
    * 
   ...
   {// GEN-FIRST:event_jButton2ActionPerformed
      ...
      if (this.m_queryrunner.isActionQuery(m_queryChoice))
      {
         ...
         if (bOK == true)
         {
            this.jTextArea2.setText(("Rows affected = " + m_queryrunner
                  .GetUpdateAmount()));
         }
         else
         {
   ...
   private int m_queryChoice = 0; // This is the default query that was
                                  // selected
