...
public class QueryFrame extends javax.swing.JFrame {
	...
	public QueryFrame(QueryRunner queryrunnerObj) {
		...
		initComponents();
		m_parmlabels = new JLabel[] { jLabel1, jLabel2, jLabel3, jLabel4,
	...
	private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (this.m_queryrunner.isParameterQuery(m_queryChoice)) {
			...
			int nAmt = this.m_queryrunner
					.GetParameterAmtForQuery(m_queryChoice);
			for (int i = 0; i < nAmt; i++) {
				m_parmlabels[i].setVisible(true);
				m_parmlabels[i]
						.setText(m_queryrunner.GetParamText(m_queryChoice, i));
	...
	private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (this.m_queryrunner.isActionQuery(m_queryChoice)) {
			...
			if (bOK == true) {
				...
				jPanel2.add(m_scrollPane);// add table in panel using add()
											// method
